        ...
        <div className="hidden lg:block">
          <div className="container mx-auto px-4 py-8 max-w-7xl">
            <div className="flex gap-8">
              {/* Left Column: Carousel with peek effect */}
              <motion.div
              ...
              >
                {/* Main Carousel with peek */}
                <div className="relative">
                  <div
                    ref={desktopCarouselRef}
                    className="overflow-x-scroll scrollbar-hide snap-x snap-mandatory flex items-center gap-4"
                    style={{
                      WebkitOverflowScrolling: "touch",
                      scrollbarWidth: "none",
                      msOverflowStyle: "none",
                    ...
                    {images.map((item, index) => {
                      ...
                      return (
                        <div
                          ...
                          className={`snap-start flex-shrink-0 transition-all duration-300 cursor-pointer ${isActive ? 'opacity-100' : 'opacity-50'}`}
                          style={{ width: "85%" }}
              ...
              <motion.div
                ...
                className="w-[400px] flex-shrink-0 flex flex-col space-y-6"
              >
                {isVideoActive && currentFeatures.length > 0 ? (
                  // Video Tour View
                  <>
